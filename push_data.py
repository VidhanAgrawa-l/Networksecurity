...
import numpy as np
import pymongo
from networksecurity.exception.exception import NetworkSecurityException # Import the custom exception class
from networksecurity.logging.logger import logging # Import the custom logger class
